...
#a)
list_LicensePlates = ["ADSDQ3","ASdSA23","21eaw"]

#b)
dict_Details = {"Name":" aarav ", "Age ":17, "telephone ":"07487 654 321", "Address ":"123 bark street"}
